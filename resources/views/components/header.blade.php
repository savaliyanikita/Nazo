  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    <defs>
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" id="menu" viewBox="0 0 24 24">
        <path fill="currentColor" d="M2 6a1 1 0 0 1 1-1h18a1 1 0 1 1 0 2H3a1 1 0 0 1-1-1m0 6.032a1 1 0 0 1 1-1h18a1 1 0 1 1 0 2H3a1 1 0 0 1-1-1m1 5.033a1 1 0 1 0 0 2h18a1 1 0 0 0 0-2z"></path>
      </symbol>
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" id="user" viewBox="0 0 24 24">
        <g fill="none" stroke="currentColor" stroke-width="1.5">
          ...
          <path stroke-linecap="round" d="M17.97 20c-.16-2.892-1.045-5-5.97-5s-5.81 2.108-5.97 5"></path>
        </g>
      </symbol>
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" id="shopping-bag" viewBox="0 0 24 24">
        <g fill="none" stroke="currentColor" stroke-width="1.5">
          <path d="M3.864 16.455c-.858-3.432-1.287-5.147-.386-6.301C4.378 9 6.148 9 9.685 9h4.63c3.538 0 5.306 0 6.207 1.154c.901 1.153.472 2.87-.386 6.301c-.546 2.183-.818 3.274-1.632 3.91c-.814.635-1.939.635-4.189.635h-4.63c-2.25 0-3.375 0-4.189-.635c-.814-.636-1.087-1.727-1.632-3.91Z"></path>
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" id="health" viewBox="0 0 24 24">
        <path fill="currentColor" d="M10.5 13H8v-3h2.5V7.5h3V10H16v3h-2.5v2.5h-3zM12 2L4 5v6.09c0 5.05 3.41 9.76 8 10.91c4.59-1.15 8-5.86 8-10.91V5zm6 9.09c0 4-2.55 7.7-6 8.83c-3.45-1.13-6-4.82-6-8.83v-4.7l6-2.25l6 2.25z"></path>
      </symbol>
      <symbol xmlns="http://www.w3.org/2000/svg" id="household" viewBox="0 0 14 14">
        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
          <path d="M12.36 6H1.64a1 1 0 0 0-1 1.13l.73 5.5a1 1 0 0 0 1 .87h9.24a1 1 0 0 0 1-.87l.73-5.5A1.001 1.001 0 0 0 12.36 6M4.5 8.5V11M7 8.5V11m2.5-2.5V11"></path>
      ...
      <symbol xmlns="http://www.w3.org/2000/svg" id="alt-arrow-left-outline" viewBox="0 0 24 24">
        <path fill="currentColor" fill-rule="evenodd" d="M15.488 4.43a.75.75 0 0 1 .081 1.058L9.988 12l5.581 6.512a.75.75 0 1 1-1.138.976l-6-7a.75.75 0 0 1 0-.976l6-7a.75.75 0 0 1 1.057-.081" clip-rule="evenodd"></path>
      </symbol>
    </defs>
  </svg>
  ...
  <ul class="d-flex list-unstyled m-0 gap-3 justify-content-center justify-content-sm-end align-items-center">
    ...
    <div class="relative bg-white hidden sm:block">
      <button id="scroll-left" class="hidden sm:block absolute left-0 top-1/2 -translate-y-1/2 z-10 px-3 py-2 text-xl text-gray-500 hover:text-yellow-600">
        ...
        <nav >        
            <div id="category-scroll" class="container mx-auto max-w-screen-xl justify-center overflow-x-auto  hide-scrollbar px-6 sm:px-8 md:px-12 py-3  ">
                <div class="inline-flex gap-6 text-sm font-medium text-gray-800">
                    <!-- Padding spacer -->
                    <span class="shrink-0 w-2"></span>
                    @foreach ($categories as $category)
                    
                    <a href="{{ route('category.show', $category->slug) }}"
                        class="shrink-0 hover:text-yellow-600 transition fw-bold px-4 py-3 fs-6" >
                        {{ $category->name }}
                    </a>
        ...
        <!-- Right Arrow -->
      <button id="scroll-right" class="hidden sm:block absolute right-0 top-1/2 -translate-y-1/2 z-10 px-3 py-2 text-xl text-gray-500  hover:text-yellow-600">
        &#10095; <!-- Right arrow symbol -->
      </button>
    </div>
  </div>
